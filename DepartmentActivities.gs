...
function buildActivityWithFactor_(activity, factor) {
  return {
    ...
    activity_group: activity.activity_group || factor.activity_group,
    scope: activity.scope || factor.scope,
    category: activity.category || factor.category,
    unit: activity.unit || factor.unit,
